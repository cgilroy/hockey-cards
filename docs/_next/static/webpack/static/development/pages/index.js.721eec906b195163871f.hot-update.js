...
var PlayerPicker = function PlayerPicker(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    outputPlayers.map(function (index) {
      ...
      var playerLink = props.playerList[index].person.link;
      playerData.push({
        name: name,
        position: position,
        number: number,
      ...
      picPromises = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
        var img = new Image();
      ...
      playerPromises = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      ...
      bigPromiseArray.push(picPromises, playerPromises);
    });

    _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.all([bigPromiseArray]).then(function (moreData) {
...
//# sourceMappingURL=index.js.721eec906b195163871f.hot-update.js.map