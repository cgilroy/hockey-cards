...
var PlayerPicker = function PlayerPicker(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.all([picPromises, playerPromises]).then(function (moreData) {
      var pics = [];
      var x = [];

      _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.all(moreData[0]).then(function (images) {
        pics = images;
      });

      _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.all(moreData[1]).then(function (results) {
        x = results;
      });
...
//# sourceMappingURL=index.js.e5795332680194747573.hot-update.js.map